...
cd ./eventvla
starVLA_PYTHON=~/miniconda3/envs/eventvla/bin/python
ROBOCASA_PYTHON=~/miniconda3/envs/robocasa/bin/python
export PYTHONPATH=$(pwd):${PYTHONPATH}
CKPT_DEFAULT="EventVLA/Qwen3-VL-OFT-Robocasa/checkpoints/steps_90000_pytorch_model.pt"
...
EvalEnv() {
    ...
    # save root CKPT_PATH parent folder
