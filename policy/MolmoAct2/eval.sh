...
echo "[MAIN] start server, port=${policy_server_port}"
...
bash "${UTILS_DIR}/wait_for_policy_server.sh" "${policy_server_ip}" "${policy_server_port}" "${SERVER_PID}" "Policy server" 1800
