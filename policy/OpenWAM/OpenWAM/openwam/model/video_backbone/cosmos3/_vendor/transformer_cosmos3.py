...
#
# Vendored from huggingface/diffusers @ 6ad357395d936c4d27347463f938cdbb400a6e59
# (src/diffusers/models/transformers/transformer_cosmos3.py, post PR #14246 Edge
# K-norm fix + PR #14054 CP seams). Sole local modification: the package-relative
# diffusers imports below were rewritten to absolute ones so the file imports
# standalone; all eight symbols exist unchanged in diffusers>=0.38. Everything
# else is byte-identical to upstream — see _vendor/README.md before editing.
...
class Cosmos3VLTextMoTDecoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.mlp = Cosmos3VLTextMLP(hidden_size=hidden_size, intermediate_size=intermediate_size, hidden_act=hidden_act)
